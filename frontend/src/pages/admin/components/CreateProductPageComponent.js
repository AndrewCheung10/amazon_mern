            ...
            <Row className="justify-content-md-center mt-5">
                ...
                <Col md={6}>
                    ...
                    >
                        ...
                        >
                            <Form.Label>
                                Or create a new category (e.g.
                                Computers/Laptops/Intel){" "}
                            </Form.Label>
                            <Form.Control
                        ...
                        {attributesFromDb.length > 0 && (
                            <Row className="mt-5">
                                <Col md={6}>
                                    ...
                                    >
                                        <Form.Label>
                                            Choose atrribute and set value
                                        </Form.Label>
                                        <Form.Select
                                            name="atrrKey"
                                            aria-label="Default select example"
                        ...
                        <Alert
                            ...
                            variant="primary"
                        >
                            After typing attribute key and value press enterr on
                            one of the field
                        </Alert>
